export const projects = [
  {
    name: 'Puppy Point',
    desc: "Puppy Point is an application created with the PERN stack that connects dog walkers with people who do not have time and want their pets to be walked.",
    img: '/images/projects/puppy-point.webp',
    url: 'https://puppypoint.vercel.app/',
    github: "https://github.com/lemorles/puppy-point"
  },
  {
    name: 'Seguros Contar',
    desc: "Seguros Contar is a SPA (Single Page Application) in which you can view the vehicle insurance quotes in real time from the company Galeno Seguros.",
    img: '/images/projects/seguros-contar.webp',
    url: 'https://cotizar.seguroscontar.com.ar/',
    github: "https://github.com/lemorles/seguros-contar"
  },
  {
    name: 'Countries App',
